...
<td><a title='Anfrage über fragdenstaat.de' href='$city[fragdenstaat_url]'>Anfrage</a></td>
    ...
    $html .= "</tbody></table>
<p>Derzeit haben " . number_format($bayernIfsResident, 0, '','.') . " (" .  round( $bayernIfsResident / $bayernAllResident * 100 , 0 )  . " %) Einwohner in Bayern Akteneinsichtsrecht gemäß kommunaler Informationsfreiheit im Bereich des eigenen Wirkungskreis der Gemeinden.</p>" ;
